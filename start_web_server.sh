#!/bin/bash
# ============================================================================
# PostgreSQL Memory System v2.3.1 - Web Server Control Script
...
do_status() {
    load_env
    echo -e "${BLUE}========================================${NC}"
    echo -e "${BLUE}  PostgreSQL Memory System v2.3.1${NC}"
    echo -e "${BLUE}========================================${NC}"
    echo ""
    if is_running; then
...
case "${1:-}" in
    ...
    log)     do_log ;;
    *)
        echo "PostgreSQL Memory System v2.3.1 - Web Server Control"
        echo ""
