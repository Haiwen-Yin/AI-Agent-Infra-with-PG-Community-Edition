...
def _ensure_agent():
    ...
    try:
        register_agent(agent_id=TEST_AGENT, agent_name="Test Loop Agent", agent_type="test")
    except Exception:
        pass
    try:
        heartbeat(TEST_AGENT)
    except Exception:
        pass
...
def test_start_run():
    ...
    print(f"PASS: test_start_run (run_id={run_id}...)")
    delete_loop(loop_id)
...
def test_record_iteration():
    ...
    print(f"PASS: test_record_iteration (iter_id={iter_id}...)")
    delete_loop(loop_id)
