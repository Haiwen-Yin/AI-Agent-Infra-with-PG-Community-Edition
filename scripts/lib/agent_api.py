"""AI Agent Infra v4.1.0 - PG Community Edition - Agent API
...
def _provision_agent_login(agent_id: str) -> Dict[str, Any]:
    ...
    with get_connection() as conn:
        with conn.cursor() as cur:
            ...
            if cur.fetchone():
                cur.execute(
                    pg_sql.SQL("ALTER ROLE {} WITH LOGIN PASSWORD %s NOSUPERUSER NOCREATEDB NOCREATEROLE NOBYPASSRLS").format(
