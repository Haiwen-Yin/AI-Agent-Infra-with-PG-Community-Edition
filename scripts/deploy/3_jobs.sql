-- ============================================================================
-- AI Agent Infra v3.7.4 - Community Edition (PostgreSQL 18.3) - Phase 3: Scheduler Jobs
-- ============================================================================
...
-- 14. Loop Trigger Job: check for scheduled Loop triggers [NEW v3.7.4]
...
-- 15. Loop Stuck Check Job: detect and timeout stuck Loop runs [NEW v3.7.4]
...
-- 16. Loop Cleanup Job: cleanup old Loop runs [NEW v3.7.4]
...
-- AI Agent Infra v3.7.4 - Community Edition (PostgreSQL 18.3) - Phase 3: Scheduler Jobs Complete (16 jobs)
