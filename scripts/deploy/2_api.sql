...
-- ============================================================
-- AI Agent Infra v3.10.2 - Enterprise Edition - PostgreSQL 18.3 - Phase 2: PL/pgSQL API Schemas
-- ============================================================
...
DECLARE
    v_config_id BIGINT;
BEGIN
    INSERT INTO ldap_config (server_url, base_dn, bind_dn, bind_credential,
        user_filter, group_filter, use_tls, sync_interval_min, group_role_mapping)
    VALUES (p_server_url, p_base_dn, p_bind_dn, p_bind_credential,
        p_user_filter, p_group_filter, p_use_tls, p_sync_interval_min, p_group_role_mapping)
...
-- ============================================================
-- AI Agent Infra v3.10.2 - Enterprise Edition - PostgreSQL 18.3 API Deployment Complete (17 schemas)
-- ============================================================
