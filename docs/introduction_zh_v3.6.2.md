# AI Agent Infra with PostgreSQL — 社区版 v3.6.2

**版本**: v3.6.2 | **日期**: 2026-06-18 | **作者**: 尹海文 | **许可**: Apache License 2.0

> v3.6.2 是 AI Agent Infra 的 PostgreSQL 社区版 Bug 修复版本，包含 15 个 Bug 修复，涵盖 Portal 聊天、用户认证、图 API、PG 兼容性等关键问题。适配 PostgreSQL 18.3 生态：psycopg2 驱动、pgvector 向量搜索、Apache AGE 属性图、pg_cron 定时任务、PL/Python3u 存储过程、pgcrypto 数据库加密、Row Security Policies 行级安全。
...
| 版本 | 日期 | 里程碑 |
|------|------|--------|
| **v3.6.2** | 2026-06-18 | Bug 修复版本：15 个 Bug 修复，包括 Portal 聊天、用户认证、图 API、PG 兼容性 |
