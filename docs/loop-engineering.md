# Loop Engineering - AI Agent Infra v3.10.0 (2026-06-19) - PG Community Edition
...
Loop Engineering is implemented as a sidecar to the Unified Entity Model. A Loop Definition is an `ENTITY` with `ENTITY_TYPE='LOOP_DEFINITION'`, extended by `LOOP_META`. Execution state is tracked in three dedicated tables, and behavior is exposed through a PL/pgSQL schema and a Python module.
