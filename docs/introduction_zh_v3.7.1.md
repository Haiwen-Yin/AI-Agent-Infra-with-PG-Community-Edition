...
├────────────────────────────────────────────────────┤
│              数据库层（Database Layer）            │
│  35 表 · 22 PL/pgSQL 基础函数 + 78 API 函数        │
│  14 模式 · 16 pg_cron 作业 · 99+ 分区子表          │
...
## 七、Bug 修复（v3.6.1 → v3.7.0）及 v3.7.1 新功能
...
## 循环工程（Loop Engineering）[NEW v3.7.1]
