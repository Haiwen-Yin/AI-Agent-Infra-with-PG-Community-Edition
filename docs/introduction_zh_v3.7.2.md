...
| 版本 | 日期 | 里程碑 |
|------|------|--------|
| **v3.7.2** | 2026-06-19 | 文档一致性修正：loop_manager ~33→~22、loop_api 32 公共函数、LOOP_CLEANUP 调度 Weekly Sunday 06:00、PL/SQL→PL/pgSQL 术语、ENTITIES 分区 7→8、评估类型 4→6、架构图对齐 |
...
## 七、Bug 修复（v3.6.1 → v3.7.0）及 v3.7.2 新功能
...
## 循环工程（Loop Engineering）[NEW v3.7.2]
