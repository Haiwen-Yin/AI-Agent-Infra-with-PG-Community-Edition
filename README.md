...
> **v4.4.12 · Community Edition · PostgreSQL**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.12 --database pg --edition <community|enterprise> --config config.json
```
