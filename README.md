...
> **v4.4.3 · Community Edition · PostgreSQL**
>
...
```bash
bash scripts/install_platform.sh initialize --database pg --edition <community|enterprise> --config config.json
```
...
The Chuanxu application is served at `http://<host>:18080/app/monitor`.
