...
> **v4.4.14 · Community Edition · PostgreSQL**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.14 --database pg --edition <community|enterprise> --config config.json
```
