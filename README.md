...
> **v4.4.13 · Community Edition · PostgreSQL**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.13 --database pg --edition <community|enterprise> --config config.json
```
